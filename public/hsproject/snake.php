...
$sql="SELECT * FROM scores ORDER BY score DESC LIMIT 9,1";
$result = mysqli_query($con, $sql);
...
tenthScore="<?php echo $tenthScore; ?>";
topScore="<?php echo $topScore; ?>";

function getTheme () {
    function changeTheme (Theme) {
        document.getElementById('style1').setAttribute('href', Theme);
    }
    var index = document.getElementById("select").selectedIndex;
    switch (index) {
        case 1: 
          changeTheme('css/normal.css');
          break;
    }
}
...
SNAKE.Snake = SNAKE.Snake || (function() {
    ...
    document.getElementById(mode).addEventListener('click', function () { snakeSpeed = 75; });
}
        me.snakeBody = {};
        ...
        me.handleDeath = function() {
            function recordScore () {
				if (me.snakeLength > tenthScore) {
    				pName = prompt("Congratulations, you are in the top 10!!!\nPlease enter your name to be added to the leaderboard");
					pScore = me.snakeLength;
					$.ajax({
					type: "POST",
					url: "insert.php",
					data: { name: pName, score: pScore}})				
				}
}
            recordScore();
...
SNAKE.Board = SNAKE.Board || (function() {
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmPauseScreen.innerHTML = "<div style='padding:10px;'>Press space to unpause</div>";
            
            elmAboutPanel = document.createElement("div");
            elmAboutPanel.className = "snake-panel-component";
            elmAboutPanel.innerHTML = "<a href='' class='snake-link'></a>";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "<p></p>Press play"+"<p></p>";
            var welcomeStart = document.createElement("c");
			welcomeStart.className = "btn-snake";
        ...
        function createTryAgainElement() {
            ...
            var tryAgainStart = document.createElement("c");
			tryAgainStart.className = "btn-snake";
...
<div id="mode-wrapper"><br /><button id="Easy" style="display:none">Easy</button><br /><button id="Medium" style="display:none">Medium</button><br /><button id="Difficult" style="display:none">Difficult</button></div>
<div id="wrapper">
